...
{
 "use strict";
 var Fs,Spa,Client,WebSharper,Obj,UI,Var$1,Operators,Templating,Runtime,Server,TemplateInstance,Arrays,ProviderBuilder,ListModel,Unchecked,Fs$Spa_Templates,Handler,Var,ConcreteVar,Snap,System,Guid,SC$1,Client$1,Templates,Doc,JavaScript,Pervasives,Abbrev,Fresh,Collections,Dictionary,View,Object,AttrProxy,CheckedInput,Numeric,HashSet,Seq,TemplateInitializer,EventTarget,Node,DictionaryUtil,Enumerator,T,SC$2,WindowOrWorkerGlobalScope,Docs,SC$3,DocElemNode,CharacterData,Storage,Elt,Prepare,Slice,DomUtility,KeyCollection,An,Settings,Mailbox,Attrs,Dyn,Array,ArrayStorage,Attrs$1,AttrModule,List,T$1,Strings,Updates,ValueCollection,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$4,BindVar,SC$5,SC$6,AppendList,SC$7,DynamicAttrNode,Scheduler,Easing,AsyncBody,SC$8,CT,HashSet$1,String,CancellationTokenSource,DomNodes,Queue,Char,Error,OperationCanceledException,Lazy,HashSetUtil,SC$9,LazyExtensionsProxy,LazyRecord,Runtime$1,console,Math,Date;
 ...
 Fs$Spa_Templates=Global.Fs$Spa_Templates=Global.Fs$Spa_Templates||{};
 ...
 SC$1=Global.StartupCode$Fs_Spa$Client=Global.StartupCode$Fs_Spa$Client||{};
 ...
 Client.Main=function()
 {
  ...
  _=(b=(t=(_this=(L=Doc.Convert(function(name)
  {
   ...
   return(b$1=(_this$2=new ProviderBuilder.New$1(),(_this$2.h.push({
    ...
    $0:"name",
    $1:name
   }),_this$2)),(p$1=Handler.CompleteHoles(b$1.k,b$1.h,[]),(i$1=new TemplateInstance.New(p$1[1],Fs$Spa_Templates.listitem(p$1[0])),b$1.i=i$1,i$1))).get_Doc();
  ...
  },function()
  {
   ...
   newName.Set("");
  })),t)),(p=Handler.CompleteHoles(b.k,b.h,[["name",0]]),(i=new TemplateInstance.New(p[1],Fs$Spa_Templates.main(p[0])),b.i=i,i))).get_Doc();
 ...
 Fs$Spa_Templates.listitem=function(h)
 {
 ...
 Fs$Spa_Templates.main=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
