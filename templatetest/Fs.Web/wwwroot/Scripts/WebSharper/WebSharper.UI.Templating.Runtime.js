...
{
 "use strict";
 var WebSharper,UI,Templating,Runtime,Server,TemplateInitializer,Obj,TemplateInstances,Handler,ProviderBuilder,TemplateInstance,Client,Collections,Dictionary,Runtime$1,Arrays,Unchecked,Var$1,Operators,Doc,Client$1,Templates,Slice,BindVar,console,View,Activator,HashSet,Enumerator,Seq,System,Guid;
