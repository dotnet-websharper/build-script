...
{
 "use strict";
 var WebSharper,Obj,Cs,Spa,App,UI,ListModel,Var$1,Template,Index,Main,ListItem,Var,Operators,ConcreteVar,Snap,Doc,JavaScript,Pervasives,Templating,Runtime,Server,TemplateInstance,Storage,Seq,Abbrev,Fresh,EventTarget,Node,Unchecked,Instance,Handler,Cs$Spa_Templates,Object,System,Guid,View,Collections,Dictionary,Instance$1,Arrays,ArrayStorage,Numeric,WindowOrWorkerGlobalScope,Docs,AttrProxy,CheckedInput,HashSet,TemplateInitializer,List,T,Enumerator,SC$1,DocElemNode,CharacterData,DomUtility,An,Client,Settings,Mailbox,DictionaryUtil,T$1,Templates,Attrs,Dyn,Docs$1,RunState,NodeSet,Concurrency,Anims,SC$2,Array,Attrs$1,SC$3,AppendList,SC$4,Elt,SC$5,Scheduler,Easing,AsyncBody,SC$6,CT,HashSet$1,Prepare,Slice,KeyCollection,AttrModule,Strings,Updates,ValueCollection,BindVar,String,CancellationTokenSource,DomNodes,Char,Error,OperationCanceledException,Lazy,HashSetUtil,SC$7,SC$8,DynamicAttrNode,Queue,LazyExtensionsProxy,LazyRecord,Runtime$1,console,Math,Date;
 ...
 Template=Spa.Template=Spa.Template||{};
 Index=Template.Index=Template.Index||{};
 Main=Index.Main=Index.Main||{};
 ListItem=Index.ListItem=Index.ListItem||{};
 Var=UI.Var=UI.Var||{};
 ...
 Cs$Spa_Templates=Global.Cs$Spa_Templates=Global.Cs$Spa_Templates||{};
 ...
 Instance$1=ListItem.Instance=ListItem.Instance||{};
 ...
 SC$2=Global.StartupCode$WebSharper_UI$Doc_Proxy=Global.StartupCode$WebSharper_UI$Doc_Proxy||{};
 Array=UI.Array=UI.Array||{};
 Attrs$1=UI.Attrs=UI.Attrs||{};
 SC$3=Global.StartupCode$WebSharper_UI$Animation=Global.StartupCode$WebSharper_UI$Animation||{};
 ...
 App=Spa.App=Runtime$1.Class({},Obj,App);
 App.ClientMain=function()
 {
  var people,newName;
  people=ListModel.FromSeq(["John","Paul"]);
  newName=Var$1.Create$1("");
  Doc.RunById("main",(new Main.New()).ListContainer$4(Doc.Convert(function(x)
  {
   return(new ListItem.New()).Name$1(x).Doc();
  },people.v)).Name(newName).Add$1(function()
  {
 ...
 Main=Index.Main=Runtime$1.Class({
  Doc:function()
  {
  ...
  {
   var completed,doc;
   completed=Handler.CompleteHoles(this.key,this.holes,[["name",0]]);
   doc=Cs$Spa_Templates.main(completed[0]);
 ...
 ListItem=Index.ListItem=Runtime$1.Class({
  Doc:function()
  {
   return this.Create().get_Doc();
  },
  ...
  Create:function()
  {
   ...
   doc=Cs$Spa_Templates.listitem(completed[0]);
 ...
 Instance=Main.Instance=Runtime$1.Class({},TemplateInstance,Instance);
 ...
 Cs$Spa_Templates.main=function(h)
 {
 ...
 Cs$Spa_Templates.listitem=function(h)
 {
  Templates.LoadLocalTemplates("index");
  return h?Templates.NamedTemplate("index",{
   $:1,
 ...
 Instance$1=ListItem.Instance=Runtime$1.Class({},TemplateInstance,Instance$1);
 ...
 KeyCollection=Collections.KeyCollection=Runtime$1.Class({},Obj,KeyCollection);
 ...
 ValueCollection=Collections.ValueCollection=Runtime$1.Class({},Obj,ValueCollection);
